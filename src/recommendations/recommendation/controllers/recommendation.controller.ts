...
export class RecommendationController {
  ...
  @Get("knn")
  @ApiOperation({
    summary: "Get K-Nearest Neighbors recommendations",
    description:
      "Returns recommendations based on similar users' preferences using KNN collaborative filtering",
  })
  async getKnnRecommendations(
    ...
    return this.recommendationService.getKnnRecommendations(
      token,
      query.id,
      k || 5
    );
